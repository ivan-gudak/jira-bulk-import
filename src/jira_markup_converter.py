...
class JiraMarkupConverter:
    ...
    def _format_issue_link(self, key: str) -> str:
        """Format a Jira issue key as a standard Markdown link."""
    ...
    def _convert_links(self, text: str) -> str:
        ...
        # the untouched outer brackets plus this replacement's own link nest
        # into corrupted output like [[US-1](url)].
